...
class TeknisIntelijenIExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ->state(function (TeknisIntelijenI $record) {
    ...
    {
        $body = 'Your teknis intelijen i export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
