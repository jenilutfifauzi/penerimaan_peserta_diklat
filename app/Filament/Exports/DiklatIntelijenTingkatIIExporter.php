...
class DiklatIntelijenTingkatIIExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('status_riwayat_diklat')->label('Lulus Diklat Intelijen Tingkat I')
            ->formatStateUsing(function ($state) {
                return $state;
            }),
            ...
            ->state(function (DiklatIntelijenTingkatII $record) {
    ...
    {
        $body = 'Your diklat intelijen tingkat i i export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
